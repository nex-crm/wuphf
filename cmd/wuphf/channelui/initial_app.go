...
func ResolveInitialOfficeApp(name string) OfficeApp {
	...
	case OfficeAppMessages, OfficeAppInbox, OfficeAppOutbox, OfficeAppRecovery, OfficeAppTasks, OfficeAppRequests, OfficeAppPolicies, OfficeAppCalendar, OfficeAppArtifacts, OfficeAppSkills:
