...
// valid slug and commits the created shelves as bootstrap metadata. It is
// idempotent and intentionally writes no notebook entries.
func (r *Repo) EnsureNotebookDirs(ctx context.Context, slugs []string) (string, error) {
	...
	args := append([]string{"add", "--"}, created...)
