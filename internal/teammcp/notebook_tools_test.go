...
func TestNotebookVisualArtifactToolsTeachHTMLGuidance(t *testing.T) {
	...
	for _, want := range []string{"after notebook_write", "self-contained", "inline CSS/JS", "no network fetches", "interactive tuning surfaces", "technical-manual artifact style", "old mathematics/physics book", "FIG_001", "visual-artifact:ra_0123456789abcdef"} {
