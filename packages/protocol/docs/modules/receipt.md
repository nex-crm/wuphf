...
| Export | File:line | Contract |
|---|---:|---|
| `PROVIDER_KIND_VALUES` | `src/receipt-types.ts:242` | Closed provider tuple: `anthropic`, `openai`, `openai-compat`, `openclaw`. Adding a value is a wire/API change and must update exhaustive consumers. |
