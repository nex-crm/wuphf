...
const MIGRATIONS: readonly Migration[] = [
  ...
  {
    version: 4,
    sql: readFileSync(new URL("./004_webauthn.sql", import.meta.url), "utf8"),
  },
  {
    version: 5,
    sql: readFileSync(new URL("./005_webauthn_ttl_indexes.sql", import.meta.url), "utf8"),
  },
  {
    version: 6,
    sql: readFileSync(new URL("./006_threads.sql", import.meta.url), "utf8"),
  },
  {
    version: 7,
    sql: readFileSync(new URL("./007_approvals.sql", import.meta.url), "utf8"),
  },
];
