...
- **Stage A correctness:** 100.0% (27/27)
- **Promoted-skill quality:** 100.0% mean over 10 files
- **Proposal volume:** 13 created, 10 interview requests, 0 over-promotions, 0 duplicates, 0 orphan requests
...
| `trap-01-bio-with-frontmatter` | FAST_PATH_TRAP | skipped | skipped | PASS | Author put name+description on a person bio. Fast-path will promote it without LLM judgment unless body-shape is checked. Surfaces the over-eager promotion failure mode. |
| `trap-02-decision-with-frontmatter` | FAST_PATH_TRAP | skipped | skipped | PASS | Decision log accidentally got name+description added during a wiki migration. Body has no skill shape; promoting it is a false positive. |
