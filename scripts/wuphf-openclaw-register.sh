...
BASE_URL="${WUPHF_REGISTER_URL:-${NEX_REGISTER_URL:-${WUPHF_BASE_URL:-${NEX_BASE_URL:-https://app.nex.ai}}/api/v1/agents/register}}"
TIMEOUT="${WUPHF_API_TIMEOUT:-${NEX_API_TIMEOUT:-120}}"
SOURCE="${WUPHF_AGENT_SOURCE:-${NEX_AGENT_SOURCE:-openclaw}}"
