...
| **P2-ii-b** | Decompose-turn classification: a planning turn's `team_task` create calls → child specs (the CEO decompose node), feeding the children P2-ii-a coordinates. | A goal decomposes into ordered tasks and runs to completion through LangGraph. |
