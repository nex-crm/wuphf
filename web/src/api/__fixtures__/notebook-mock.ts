...
const PM_ENTRIES: NotebookEntry[] = [
  ...
  },
  {
    ...
    revisions: 1,
    status: 'in-review',
    file_path: '~/.wuphf/wiki/agents/pm/notebook/2026-04-20-pricing-objections.md',
    reviewer_slug: 'ceo',
  },
  {
    agent_slug: 'pm',
    ...
    revisions: 5,
    status: 'promoted',
    file_path: '~/.wuphf/wiki/agents/pm/notebook/2026-04-19-onboarding-gotchas.md',
    reviewer_slug: 'ceo',
    promoted_to_path: 'playbooks/customer-onboarding',
  },
  {
...
const ENG_ENTRIES: NotebookEntry[] = [
  {
    ...
    file_path: '~/.wuphf/wiki/agents/be/notebook/2026-04-19-broker-architecture.md',
    reviewer_slug: 'ceo',
  },
  {
    agent_slug: 'be',
...
const DESIGNER_ENTRIES: NotebookEntry[] = [
  {
    ...
    revisions: 1,
    status: 'draft',
    file_path: '~/.wuphf/wiki/agents/designer/notebook/2026-04-20-brand-voice-audit.md',
    reviewer_slug: 'ceo',
  },
]
...
const CMO_ENTRIES: NotebookEntry[] = [
  {
    ...
    revisions: 2,
    status: 'draft',
    file_path: '~/.wuphf/wiki/agents/cmo/notebook/2026-04-18-launch-channels.md',
    reviewer_slug: 'ceo',
  },
]
...
export function mockEntry(slug: string, entrySlug: string): NotebookEntry | null {
  return ALL_ENTRIES.find((e) => e.agent_slug === slug && e.entry_slug === entrySlug) ?? null
}
...
const CHANGES_REQ_COMMENTS: ReviewComment[] = [
  {
    id: 'c1',
    author_slug: 'be',
    body_md: "Submitting for review. SSE is still the right choice IMO — happy to expand on the scaling angle if useful.",
    ts: iso(60 * 24),
  },
  {
    id: 'c2',
    author_slug: 'ceo',
    body_md: "Good decision doc. One ask: spell out the backpressure behavior when a single client lags. Also a sentence on monitoring — what's the alarm threshold?",
    ts: iso(60 * 20),
  },
  {
    id: 'c3',
    author_slug: 'be',
    body_md: "On it. Will push a revision tonight covering both. Also adding a note on reconnection jitter.",
    ts: iso(60 * 18),
  },
]
...
export const MOCK_REVIEWS: ReviewItem[] = [
  {
    ...
    excerpt: "Talked to their ops lead (S.) for 45 min. Main friction is the handoff between sales and fulfillment — they're doing it in Slack. That's the wedge.",
    reviewer_slug: 'ceo',
    state: 'pending',
    submitted_ts: iso(45),
    updated_ts: iso(45),
  ...
  },
  {
    ...
    excerpt: '$2,400 reads as "enterprise budget" to Ops leads with no SaaS precedent line-item. $1,200 reads as "SMB tool".',
    reviewer_slug: 'ceo',
    state: 'in-review',
    ...
    comments: [
      {
        id: 'r-pricing-c1',
        author_slug: 'pm',
        body_md: 'Submitting. Think this is a real playbook — we keep seeing the same two tier reactions.',
        ts: iso(60 * 6),
      },
      {
        id: 'r-pricing-c2',
  ...
  },
  {
    ...
    excerpt: 'Sticking with the SSE-per-client broker. Reconnection story is boring and reliable; fan-out scales to the team sizes we care about.',
    reviewer_slug: 'ceo',
  ...
  },
  {
    ...
    excerpt: 'Warehouse manager intro call (week 1). Route-import dry run (week 2). Ops review attendance (week 3).',
    reviewer_slug: 'ceo',
    state: 'approved',
